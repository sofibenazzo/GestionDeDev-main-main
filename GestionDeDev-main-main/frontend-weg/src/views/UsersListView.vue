...
import { ShieldUser, UserPlus, Search, Edit, Trash2, ShieldCheck, UserCircle } from 'lucide-vue-next';
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
      ...
      <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 flex items-center gap-6">
        ...
        <div>
          ...
          <span class="text-3xl font-black text-slate-900">{{ users.filter(u => getRoleName(u.rolId) === 'Administrador').length }}</span>
        </div>
      </div>
    </div>
